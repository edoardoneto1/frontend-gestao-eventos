          ...
          {!loading && !erro && inscricoes.length > 0 && (
            <div className="space-y-4">
              {inscricoes.map((inscricao) => (
                <div
                  key={inscricao.id}
                  className="bg-white rounded-lg border border-blue-900 p-6 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4"
                >
                  <div>
                  ...
                  {inscricao.evento && (
                    <Link
                      href={`/eventos`}
                      className="text-center bg-blue-900 hover:bg-blue-800 text-white px-6 py-2 rounded-md font-medium transition whitespace-nowrap"
                    >
                      Ver evento
                    </Link>
                  )}
